...
public class MenuController {
	...
	public ResponseEntity<ResponseStructure<Menu>> saveUser(@RequestBody Menu menu) {
	...
	@GetMapping(consumes = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_ATOM_XML_VALUE},produces = 
			MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseStructure<Menu>> getUserById(@RequestParam int id){
	...
	@PutMapping(consumes = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_ATOM_XML_VALUE},produces = 
			MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseStructure<Menu>> updateUserById(@RequestBody Menu menu, @RequestParam int id){
